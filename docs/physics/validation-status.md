...
what is *demonstrably correct* versus what is *plausible but unverified*.
...
**no red-card modes** — every mode has at least property-level
assertions.

## Provenance of this document

Written 2026-05-03 by counting tests in `src/tests/lib/physics/` and
