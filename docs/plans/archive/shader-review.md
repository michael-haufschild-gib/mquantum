...
*Generated by comprehensive shader review - 2025-12-29*
  ...
  1. Power-specialized shader variants - Eliminates branch cascade, easy win
  2. Fast sin/cos approximations - Biggest cycle savings potential
  3. mediump for non-critical values - Mobile perf + register pressure
