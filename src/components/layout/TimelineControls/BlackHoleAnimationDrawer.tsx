 ...
 */
export const BlackHoleAnimationDrawer: React.FC<BlackHoleAnimationDrawerProps> = React.memo(
  ({ onClose }) => {
    ...
    return (
      <AnimationDrawerContainer onClose={onClose} data-testid="blackhole-animation-drawer">
        ...
        <div className="space-y-4" data-testid="animation-panel-pulse">
          ...
          <div
            className={`space-y-3 ${!config.pulseEnabled ? 'opacity-50 pointer-events-none' : ''}`}
          >
            <Slider
              label="Speed"
              min={0.1}
