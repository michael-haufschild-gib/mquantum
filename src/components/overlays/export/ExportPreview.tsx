  ...
  return (
    <div className="relative w-full h-full bg-[var(--bg-app)]/50 flex items-center justify-center p-4">
      ...
      >
        {previewImage ? (
          <>
            ...
            <img src={previewImage} className="w-full h-full object-cover" alt="Scene Preview" />
      ...
      <div className="absolute top-4 start-4 flex gap-2">
        <div className="px-2 py-1 surface-panel rounded text-xs font-mono text-[var(--text-secondary)]">
          PREVIEW
        </div>
        {crop.enabled && (
