  ...
  return (
    <div className="space-y-1 border-t border-[var(--border-subtle)] pt-2">
      ...
      <div className="grid grid-cols-3 gap-x-3 gap-y-0.5">
        <Slider
          data-testid="components-sections-analysis-bell-sweep-panel-slider-179-9"
          label="η steps"
          min={2}
          max={32}
          step={1}
        ...
        />
        <Slider
          data-testid="components-sections-analysis-bell-sweep-panel-slider-189-9"
          label="v steps"
          min={2}
          max={32}
          step={1}
        ...
        />
        <Slider
          data-testid="components-sections-analysis-bell-sweep-panel-slider-199-9"
          label="Trials / cell"
          min={500}
          max={50_000}
          step={500}
