      ...
      >
        ...
        >
          ...
          <div className="flex items-center justify-between">
            <Switch
              data-testid="components-sections-analysis-coordinate-entanglement-section-switch-151-13"
              label="Enable"
            ...
            {enabled && (sweepStatus === 'idle' || sweepStatus === 'complete') && (
              <Button
                data-testid="components-sections-analysis-coordinate-entanglement-section-button-159-15"
                variant="primary"
                size="sm"
            ...
            {enabled && sweepStatus === 'running' && (
              <div className="flex items-center gap-2">
                ...
                <Button
                  data-testid="components-sections-analysis-coordinate-entanglement-section-button-173-17"
                  variant="secondary"
                  size="sm"
            ...
            <>
              ...
              <div className="mt-1 flex gap-4">
                <div className="flex flex-col gap-1 shrink-0">
                  <Switch
                    data-testid="components-sections-analysis-coordinate-entanglement-section-switch-193-19"
                    label="Pairwise MI"
                  ...
                  />
                  <Switch
                    data-testid="components-sections-analysis-coordinate-entanglement-section-switch-200-19"
                    label="Bipartitions"
                  ...
                  />
                  <Switch
                    data-testid="components-sections-analysis-coordinate-entanglement-section-switch-207-19"
