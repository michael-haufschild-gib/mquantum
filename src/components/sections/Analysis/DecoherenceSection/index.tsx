    ...
    <Section title="Decoherence">
      ...
      >
        <div className="py-1.5">
          <Switch
            data-testid="components-sections-analysis-decoherence-section-switch-104-11"
        ...
        {tdse.stochasticEnabled && (
          <>
            ...
            >
              <Slider
                data-testid="components-sections-analysis-decoherence-section-slider-121-15"
              ...
              />
              <Slider
                data-testid="components-sections-analysis-decoherence-section-slider-130-15"
              ...
              />
              <Slider
                data-testid="components-sections-analysis-decoherence-section-slider-139-15"
            ...
            >
              {tdse.branchingEnabled && (
                <>
                  <Slider
                    data-testid="components-sections-analysis-decoherence-section-slider-177-19"
                    label="Branch plane"
                  ...
                  <div className="flex space-x-4">
                    <ColorPicker
                      data-testid="components-sections-analysis-decoherence-section-color-picker-187-21"
                      label="Branch A"
                    ...
                    />
                    <ColorPicker
                      data-testid="components-sections-analysis-decoherence-section-color-picker-193-21"
                      label="Branch B"
