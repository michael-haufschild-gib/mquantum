...
export const FSFAnalysisContent: React.FC = React.memo(() => {
  ...
  return (
    <>
      ...
      <Slider
        data-testid="components-sections-analysis-fsfanalysis-section-slider-85-7"
...
const CosmologyReadout: React.FC<{
  ...
  if (!snapshot) {
    return (
      <ControlGroup
        data-testid="components-sections-analysis-fsfanalysis-section-control-group-533-7"
