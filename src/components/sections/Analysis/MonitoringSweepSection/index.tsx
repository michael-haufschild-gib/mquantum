...
export const MonitoringSweepSection: React.FC = React.memo(() => {
  ...
  return (
    <>
      <ControlGroup
        data-testid="components-sections-analysis-monitoring-sweep-section-control-group-203-7"
        title="Monitoring Dynamics"
        collapsible
        defaultOpen={false}
      >
      ...
      >
        ...
        {!isRunning && !isComplete && (
          <div className="space-y-1 mb-2">
            <div className="flex gap-2">
              <NumberInput
                data-testid="components-sections-analysis-monitoring-sweep-section-number-input-243-15"
                label="γ min"
                value={gammaMin}
              ...
              />
              <NumberInput
                data-testid="components-sections-analysis-monitoring-sweep-section-number-input-252-15"
                label="γ max"
                value={gammaMax}
            ...
            <div className="flex gap-2">
              <NumberInput
                data-testid="components-sections-analysis-monitoring-sweep-section-number-input-263-15"
                label="Steps"
                value={steps}
              ...
              />
              <NumberInput
                data-testid="components-sections-analysis-monitoring-sweep-section-number-input-272-15"
                label="Time/step"
                value={timePerStep}
        ...
        {!isRunning && !isComplete && (
          <Button
            data-testid="components-sections-analysis-monitoring-sweep-section-button-286-11"
            size="sm"
        ...
        {isRunning && (
          <Button
            data-testid="components-sections-analysis-monitoring-sweep-section-button-296-11"
            size="sm"
            variant="primary"
            onClick={handleAbort}
        ...
        {isComplete && (
          <Button
            data-testid="components-sections-analysis-monitoring-sweep-section-button-306-11"
            size="sm"
            variant="primary"
            onClick={handleClear}
