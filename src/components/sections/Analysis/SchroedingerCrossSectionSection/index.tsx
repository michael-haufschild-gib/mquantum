        ...
        {config.crossSectionEnabled && (
          <div className="space-y-2">
            ...
            <div data-testid="schroedinger-cross-section-plane-color">
              <ColorPicker
                data-testid="components-sections-analysis-schroedinger-cross-section-section-color-picker-300-15"
                label="Plane Color"
          ...
          {config.radialProbabilityEnabled && (
            <div className="space-y-2">
              ...
              >
                ...
                <ColorPicker
                  data-testid="components-sections-analysis-schroedinger-cross-section-section-color-picker-389-17"
                  value={
