      ...
      >
        <div className="space-y-2" data-testid="heller-spectrometer-panel">
          ...
          <details className="mt-2 text-2xs" data-testid="heller-advanced-disclosure">
            <summary
              data-testid="components-sections-analysis-tdsespectrometer-panel-summary-448-13"
              className="cursor-pointer text-text-tertiary uppercase tracking-wider select-none"
            >
              Advanced
            </summary>
            <div className="mt-2">
