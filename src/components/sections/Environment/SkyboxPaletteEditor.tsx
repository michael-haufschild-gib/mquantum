...
const SkyboxPresetSelector: React.FC<SkyboxPresetSelectorProps> = ({ coefficients, onSelect }) => {
                ...
                {CHANNEL_LABELS.map((channel, index) => (
                  <div key={channel} className="space-y-1">
                    ...
                    <input
                      ...
                      onChange={(e) => onChange(key, index, parseFloat(e.target.value))}
...
export const SkyboxPaletteEditor: React.FC = () => {
  ...
  return (
    <div className="space-y-4 animate-in fade-in zoom-in-95 duration-200">
      ...
      {/* Preset Selector */}
      <SkyboxPresetSelector coefficients={cosineCoefficients} onSelect={handlePresetSelect} />
