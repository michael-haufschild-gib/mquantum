...
import { JULIA_CONSTANT_PRESETS } from '@/lib/geometry/extended/types'
      ...
      <div className={className} data-testid="quaternion-julia-controls">
        <Section title="Julia Constant" defaultOpen={true}>
          <div className="space-y-2">
            ...
            <div className="grid grid-cols-2 gap-2">
              <Slider
                ...
                onChange={(v) =>
                  setJuliaConstant([
                    v,
                    config.juliaConstant[1],
                    config.juliaConstant[2],
                    config.juliaConstant[3],
                  ])
                }
                showValue
            ...
            <p className="text-xs text-text-tertiary">The fixed constant c in z = z^n + c</p>
          </div>
        </Section>
        ...
        <Section title="Parameters" defaultOpen={true}>
          {/* Power Control */}
          <div className="space-y-2">
            <label className="text-xs text-text-secondary">Power (n={config.power})</label>
            <ToggleGroup
