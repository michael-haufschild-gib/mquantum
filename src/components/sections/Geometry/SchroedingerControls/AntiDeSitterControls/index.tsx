...
export const AntiDeSitterControls: React.FC = React.memo(() => {
  ...
  return (
    <div className="space-y-3" data-testid="anti-de-sitter-controls">
      ...
      <ControlGroup
        data-testid="components-sections-geometry-schroedinger-controls-anti-de-sitter-controls-control-group-288-7"
        title="Dimensions & Quantum Numbers"
        collapsible
        defaultOpen
      >
        <Slider
      ...
      {showMass && (
        <ControlGroup
          data-testid="components-sections-geometry-schroedinger-controls-anti-de-sitter-controls-control-group-342-9"
          title="Mass & Quantization"
          collapsible
          defaultOpen
        >
          <Slider
