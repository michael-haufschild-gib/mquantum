  ...
  ({ config, dimension, actions }) => {
    ...
    return (
      <div className="space-y-1">
        ...
        >
          <Select
            data-testid="components-sections-geometry-schroedinger-controls-beccontrols-select-131-11"
          ...
          {showVortexControls && (
            <>
              <Slider
                data-testid="components-sections-geometry-schroedinger-controls-beccontrols-slider-141-15"
                label="Vortex Charge"
              ...
              {bec.initialCondition === 'vortexLattice' && (
                <Slider
                  data-testid="components-sections-geometry-schroedinger-controls-beccontrols-slider-151-17"
                  label="Vortex Count"
          ...
          {showReconnectionControls && (
            <>
              <Slider
                data-testid="components-sections-geometry-schroedinger-controls-beccontrols-slider-189-15"
                label="Vortex Charge"
              ...
              />
              <Slider
                data-testid="components-sections-geometry-schroedinger-controls-beccontrols-slider-218-15"
                label="Separation"
              ...
              />
              <Select
                data-testid="components-sections-geometry-schroedinger-controls-beccontrols-select-227-15"
                label="Vortex Count"
        ...
        >
          <Slider
            data-testid="components-sections-geometry-schroedinger-controls-beccontrols-slider-311-11"
          ...
          />
          <Slider
            data-testid="components-sections-geometry-schroedinger-controls-beccontrols-slider-320-11"
            label="Trap ω"
          ...
          {activeDims > 1 &&
            Array.from({ length: activeDims }, (_, i) => (
              <Slider
                data-testid="components-sections-geometry-schroedinger-controls-beccontrols-slider-331-15"
                key={`aniso-${i}`}
        ...
        >
          ...
          {Array.from({ length: activeDims }, (_, i) => (
            <Slider
              data-testid="components-sections-geometry-schroedinger-controls-beccontrols-slider-415-13"
              key={`spacing-${i}`}
          ...
          <Slider
            data-testid="components-sections-geometry-schroedinger-controls-beccontrols-slider-430-11"
            label="Mass"
          ...
          />
          <Slider
            data-testid="components-sections-geometry-schroedinger-controls-beccontrols-slider-439-11"
            label="ℏ"
          ...
          />
          <Slider
            data-testid="components-sections-geometry-schroedinger-controls-beccontrols-slider-448-11"
            label="dt"
          ...
          />
          <Slider
            data-testid="components-sections-geometry-schroedinger-controls-beccontrols-slider-457-11"
            label="Steps/Frame"
        ...
        {activeDims > 3 && bec.slicePositions.length > 0 && (
          ...
          >
            {Array.from({ length: Math.min(activeDims - 3, bec.slicePositions.length) }, (_, i) => {
              ...
              return (
                <Slider
                  data-testid="components-sections-geometry-schroedinger-controls-beccontrols-slider-480-17"
                  key={`slice-${dimIdx}`}
