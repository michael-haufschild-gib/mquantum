...
export const DiracControls = React.memo(({ config, dimension, actions }: DiracControlsProps) => {
  ...
  return (
    <div className="space-y-1">
      ...
      >
        <Select
          data-testid="components-sections-geometry-schroedinger-controls-dirac-controls-select-135-9"
      ...
      >
        <Select
          data-testid="components-sections-geometry-schroedinger-controls-dirac-controls-select-150-9"
          label="Field View"
      ...
      >
        <Switch
          data-testid="components-sections-geometry-schroedinger-controls-dirac-controls-switch-165-9"
        ...
        />
        <Select
          data-testid="components-sections-geometry-schroedinger-controls-dirac-controls-select-171-9"
          label="Potential"
        ...
        {showPotentialParams && (
          <>
            ...
            {showBarrierWidth && (
              <Slider
                data-testid="components-sections-geometry-schroedinger-controls-dirac-controls-slider-193-15"
            ...
            {showPotentialCenter && (
              <Slider
                data-testid="components-sections-geometry-schroedinger-controls-dirac-controls-slider-204-15"
            ...
            {showHarmonicOmega && (
              <Slider
                data-testid="components-sections-geometry-schroedinger-controls-dirac-controls-slider-215-15"
      ...
      >
        <Slider
          data-testid="components-sections-geometry-schroedinger-controls-dirac-controls-slider-246-9"
          label="Mass m"
        ...
        />
        <Slider
          data-testid="components-sections-geometry-schroedinger-controls-dirac-controls-slider-255-9"
        ...
        />
        <Slider
          data-testid="components-sections-geometry-schroedinger-controls-dirac-controls-slider-264-9"
        ...
        />
        <Slider
          data-testid="components-sections-geometry-schroedinger-controls-dirac-controls-slider-273-9"
        ...
        {Array.from({ length: Math.min(latticeDim, 3) }, (_, d) => {
          ...
          return (
            <Slider
              data-testid="components-sections-geometry-schroedinger-controls-dirac-controls-slider-285-13"
              key={`mom-${d}`}
      ...
      >
        ...
        {Array.from({ length: latticeDim }, (_, d) => (
          <Slider
            data-testid="components-sections-geometry-schroedinger-controls-dirac-controls-slider-318-11"
            key={`spacing-${d}`}
        ...
        <Slider
          data-testid="components-sections-geometry-schroedinger-controls-dirac-controls-slider-333-9"
          label="Time Step dt"
        ...
        />
        <Slider
          data-testid="components-sections-geometry-schroedinger-controls-dirac-controls-slider-342-9"
        ...
        {latticeDim > 3 &&
          Array.from({ length: latticeDim - 3 }, (_, i) => {
            ...
            return (
              <Slider
                data-testid="components-sections-geometry-schroedinger-controls-dirac-controls-slider-356-15"
                key={`slice-${d}`}
