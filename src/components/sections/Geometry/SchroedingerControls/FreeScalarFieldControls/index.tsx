    ...
    return (
      <div className="space-y-1">
        ...
        {latticeDim > 3 && (
          ...
          >
            {Array.from({ length: latticeDim - 3 }, (_, i) => {
              ...
              return (
                <Slider
                  data-testid="components-sections-geometry-schroedinger-controls-free-scalar-field-controls-slider-284-17"
                  key={`slice-${dimIdx}`}
        ...
        <ControlGroup
          ...
          rightElement={
            <Switch
              data-testid="components-sections-geometry-schroedinger-controls-free-scalar-field-controls-switch-306-13"
        ...
        >
          {fs.selfInteractionEnabled && (
            <>
              <Slider
                data-testid="components-sections-geometry-schroedinger-controls-free-scalar-field-controls-slider-316-15"
                label="λ"
              ...
              />
              <Slider
                data-testid="components-sections-geometry-schroedinger-controls-free-scalar-field-controls-slider-326-15"
                label="v (VEV)"
        ...
        >
          ...
          {fs.initialCondition === 'singleMode' && (
            <div className="space-y-2">
              {Array.from({ length: latticeDim }, (_, d) => (
                <Slider
                  data-testid="components-sections-geometry-schroedinger-controls-free-scalar-field-controls-slider-399-17"
                  key={`modeK-${d}`}
          ...
          {usesPacketControls && (
            <div className="space-y-2">
              ...
              {Array.from({ length: latticeDim }, (_, d) => (
                <Slider
                  data-testid="components-sections-geometry-schroedinger-controls-free-scalar-field-controls-slider-428-17"
                  key={`center-${d}`}
              ...
              {Array.from({ length: latticeDim }, (_, d) => (
                <Slider
                  data-testid="components-sections-geometry-schroedinger-controls-free-scalar-field-controls-slider-441-17"
                  key={`modeK-${d}`}
                  label={`k_${AXIS_LABELS[d] ?? d}`}
