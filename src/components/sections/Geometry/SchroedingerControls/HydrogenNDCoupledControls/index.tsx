  ...
  ({ config, dimension, actions }) => {
    ...
    return (
      <div className="space-y-3">
        <ControlGroup
          data-testid="components-sections-geometry-schroedinger-controls-hydrogen-ndcoupled-controls-control-group-108-9"
          title="Quantum Numbers"
        >
          {/* Principal quantum number n */}
          <Slider
            data-testid="components-sections-geometry-schroedinger-controls-hydrogen-ndcoupled-controls-slider-110-11"
            label="n (principal)"
          ...
          {/* Angular momentum l₁ */}
          <Select
            data-testid="components-sections-geometry-schroedinger-controls-hydrogen-ndcoupled-controls-select-121-11"
          ...
          <Select
            data-testid="components-sections-geometry-schroedinger-controls-hydrogen-ndcoupled-controls-select-130-11"
            label="m (magnetic)"
        ...
        {chainLength > 0 && (
          <ControlGroup
            data-testid="components-sections-geometry-schroedinger-controls-hydrogen-ndcoupled-controls-control-group-141-11"
            title="Angular Momentum Chain"
            collapsible
            defaultOpen
          >
            ...
            {Array.from({ length: chainLength }, (_, i) => {
              ...
              return (
                <Slider
                  data-testid="components-sections-geometry-schroedinger-controls-hydrogen-ndcoupled-controls-slider-151-17"
                  key={i}
        ...
        <ControlGroup
          data-testid="components-sections-geometry-schroedinger-controls-hydrogen-ndcoupled-controls-control-group-167-9"
          title="Display"
        >
          <Switch
            data-testid="components-sections-geometry-schroedinger-controls-hydrogen-ndcoupled-controls-switch-168-11"
            label="Real orbitals"
          ...
          />
          <Slider
            data-testid="components-sections-geometry-schroedinger-controls-hydrogen-ndcoupled-controls-slider-174-11"
            label="Bohr radius"
