...
export function useSchroedingerActions(): SchroedingerActionsResult {
  const extendedObjectSelector = useShallow((state: ExtendedObjectState) => ({
    ...
    setFreeScalarAbsorberEnabled: state.setFreeScalarAbsorberEnabled,
    setFreeScalarAbsorberWidth: state.setFreeScalarAbsorberWidth,
    setFreeScalarPmlTargetReflection: state.setFreeScalarPmlTargetReflection,
    ...
    setTdsePmlTargetReflection: state.setTdsePmlTargetReflection,
    ...
    setBecPmlTargetReflection: state.setBecPmlTargetReflection,
    ...
    setDiracPmlTargetReflection: state.setDiracPmlTargetReflection,
