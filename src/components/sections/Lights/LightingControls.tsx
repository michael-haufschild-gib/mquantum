...
export const LightingControls: React.FC<LightingControlsProps> = React.memo(
  ({ className = '' }) => {
    ...
    const { ssaoEnabled, setSSAOEnabled, ssaoIntensity, setSSAOIntensity } =
    ...
    const handleAoQualityChange = useCallback(
      (val: string) => {
    ...
    return (
      <div className={`space-y-4 ${className}`}>
        ...
        >
          <p className="text-[10px] text-text-secondary mb-2">{aoTypeLabel}</p>
          <div
