...
function getChildTestId(testId: string | undefined, child: string): string | undefined {
  return testId ? `${testId}-${child}` : undefined
}
    ...
    return (
      ...
      >
        ...
        <div className="flex items-center justify-between mb-2 h-5">
          <label
            data-testid={getChildTestId(dataTestId, 'label')}
            htmlFor={id}
            className={`
              ...
              <div className="relative w-[8ch] h-5 flex items-center">
                <input
                  ...
                  className={`
                    ...
                    ${unit ? 'pe-7' : 'pe-1.5'}
                  `}
                  data-testid={getChildTestId(dataTestId, 'input')}
                />
                {unit && (
        ...
        <div className="relative h-5 flex items-center touch-none">
          ...
          <input
            data-testid={getChildTestId(dataTestId, 'range')}
            id={id}
            type="range"
            min={safeMin}
            max={safeMax}
          ...
          >
            ...
            <div
              className={`w-1 h-1 rounded-full bg-text-primary transition-opacity duration-200 ${isDragging ? 'opacity-100' : 'opacity-50 group-hover/slider:opacity-100'}`}
            />
          </div>
