...
export const FREE_SCALAR_PRESETS: FreeScalarScenarioPreset[] = [
  ...
  },
  {
    ...
    overrides: {
      ...
      initialCondition: 'rankDefectGenesis',
      packetCenter: [0, 0, 0],
      packetWidth: 0.9,
  ...
  {
    id: 'retrocausalCausticFlower',
    name: 'Retrocausal Caustic Flower',
    description:
      'Bounded recursive advanced/retarded image sum in the free scalar buffers. A wider mouth map seeds nested flower and shell caustics with a nonzero conjugate-momentum kick.',
    overrides: {
      latticeDim: 3,
      gridSize: [64, 64, 64],
      spacing: [0.12, 0.12, 0.12],
    ...
    renderingOverrides: { densityGain: 1.8, densityContrast: 1.7 },
  },
  {
    id: 'retrocausalCausticWeb',
    name: 'Retrocausal Caustic Web',
    description:
      'Narrow massless retrocausal image map with a different mode vector. Energy-density view turns the recursive kick into sharp branching web caustics.',
    overrides: {
      latticeDim: 3,
      gridSize: [64, 64, 64],
      spacing: [0.11, 0.11, 0.11],
      initialCondition: 'retrocausalCaustic',
      packetCenter: [0, 0, 0],
      packetWidth: 0.42,
      packetAmplitude: 0.9,
    ...
    renderingOverrides: { densityGain: 0.9, densityContrast: 2.2 },
  },
