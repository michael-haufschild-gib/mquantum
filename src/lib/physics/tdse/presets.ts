...
export const TDSE_SCENARIO_PRESETS: TdseScenarioPreset[] = [
  ...
  },
  {
    ...
    name: 'CTC Causal Shadow: Head-On Echo',
    description:
      'Centered high-momentum packet in the causal-shadow view. The mirror-reflected echo current runs against the local current, so coherent high-feedback regions draw bright causal-shadow bands.',
    maxDim: 3,
    overrides: {
      latticeDim: 3,
      gridSize: [64, 64, 64],
  ...
  },
  {
    ...
    name: 'CTC Causal Shadow: Phase Slip',
    description:
      'Same causal-shadow geometry with pi-over-two loop phase and transverse momentum shear. The echo remains visible but weaker and skewed, separating current opposition from phase coherence.',
    maxDim: 3,
    overrides: {
      latticeDim: 3,
      gridSize: [64, 64, 64],
