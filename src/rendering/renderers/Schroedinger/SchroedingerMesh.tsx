...
import { MAX_DIMENSION, useQualityTracking, useRotationUpdates } from '@/rendering/renderers/base'
import {
...
const SchroedingerMesh = () => {
  ...
  const energyColorEnabled = useExtendedObjectStore(
    (state) => state.schroedinger.energyColorEnabled
  )
  ...
  useFrame((state) => {
    ...
    if (meshRef.current) {
      ...
      if (material.uniforms.uUseRealOrbitals)
        material.uniforms.uUseRealOrbitals.value = useRealOrbitals
      ...
      if (material.uniforms.uHydrogenNDBoost)
        material.uniforms.uHydrogenNDBoost.value = hydrogenNDBoost
      ...
      if (material.uniforms.uHydrogenRadialThreshold)
        material.uniforms.uHydrogenRadialThreshold.value = hydrogenRadialThreshold
      ...
      const needsPresetRegen =
        ...
        Math.abs(prevQuantumConfigRef.current.frequencySpread - currentConfig.frequencySpread) >
          0.001 || // Float compare
      ...
      if (schroedingerChanged) {
        ...
        if (material.uniforms.uScatteringAnisotropy)
          material.uniforms.uScatteringAnisotropy.value = scatteringAnisotropy

        // Erosion
        if (material.uniforms.uErosionStrength)
          material.uniforms.uErosionStrength.value = erosionStrength
        if (material.uniforms.uErosionScale) material.uniforms.uErosionScale.value = erosionScale
        if (material.uniforms.uErosionTurbulence)
          material.uniforms.uErosionTurbulence.value = erosionTurbulence
        if (material.uniforms.uErosionNoiseType)
          material.uniforms.uErosionNoiseType.value = erosionNoiseType
        ...
        // Dispersion
        if (material.uniforms.uDispersionEnabled)
          material.uniforms.uDispersionEnabled.value = dispersionEnabled
        if (material.uniforms.uDispersionStrength)
          material.uniforms.uDispersionStrength.value = dispersionStrength
        if (material.uniforms.uDispersionDirection)
          material.uniforms.uDispersionDirection.value = dispersionDirection
        if (material.uniforms.uDispersionQuality)
          material.uniforms.uDispersionQuality.value = dispersionQuality

        // Shadows
        if (material.uniforms.uShadowsEnabled)
          material.uniforms.uShadowsEnabled.value = shadowsEnabled
        ...
        if (material.uniforms.uAoColor) {
          updateLinearColorUniform(
            cache.faceColor /* reuse helper */,
            material.uniforms.uAoColor.value as THREE.Color,
            aoColor || '#000000'
          )
        }
        ...
        if (material.uniforms.uNodalColor) {
          updateLinearColorUniform(
            cache.faceColor /* reuse helper */,
            material.uniforms.uNodalColor.value as THREE.Color,
            nodalColor || '#00ffff'
          )
        }
        if (material.uniforms.uEnergyColorEnabled)
          material.uniforms.uEnergyColorEnabled.value = energyColorEnabled
        if (material.uniforms.uShimmerEnabled)
          material.uniforms.uShimmerEnabled.value = shimmerEnabled
        if (material.uniforms.uShimmerStrength)
          material.uniforms.uShimmerStrength.value = shimmerStrength
      ...
      if (appearanceChanged) {
        ...
        if (material.uniforms.uEmissionIntensity)
          material.uniforms.uEmissionIntensity.value = faceEmission
        if (material.uniforms.uEmissionThreshold)
          material.uniforms.uEmissionThreshold.value = faceEmissionThreshold
        if (material.uniforms.uEmissionColorShift)
          material.uniforms.uEmissionColorShift.value = faceEmissionColorShift
        if (material.uniforms.uEmissionPulsing)
          material.uniforms.uEmissionPulsing.value = faceEmissionPulsing
        ...
        if (material.uniforms.uSssColor) {
          updateLinearColorUniform(
            cache.faceColor /* reuse helper */,
            material.uniforms.uSssColor.value as THREE.Color,
            sssColor || '#ff8844'
          )
        }
        ...
        // Fresnel
        if (material.uniforms.uFresnelEnabled)
          material.uniforms.uFresnelEnabled.value = edgesVisible
        if (material.uniforms.uFresnelIntensity)
          material.uniforms.uFresnelIntensity.value = fresnelIntensity
        if (material.uniforms.uRimColor) {
          updateLinearColorUniform(
            cache.rimColor,
            material.uniforms.uRimColor.value as THREE.Color,
            edgeColor
          )
        }
      ...
      if (iblChanged) {
        ...
        if (material.uniforms.uIBLQuality) {
          ...
          material.uniforms.uIBLQuality.value = isPMREM
            ? qualityMap[environmentState.iblQuality]
            : 0
        }
