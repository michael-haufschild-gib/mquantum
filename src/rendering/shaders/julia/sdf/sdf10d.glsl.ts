...
// ============================================
// 10D Julia SDF - Array-based with inversesqrt optimization
...
float sdfJulia10D(vec3 pos, float pwr, float bail, int maxIt, out float trap) {
    ...
    c[4] = 0.0; c[5] = 0.0; c[6] = 0.0; c[7] = 0.0; c[8] = 0.0; c[9] = 0.0;
    ...
    for (int i = 0; i < MAX_ITER_HQ; i++) {
        ...
        r = sqrt(z01_sq + z[2]*z[2] + z[3]*z[3] + z[4]*z[4] + z[5]*z[5] + z[6]*z[6] + z[7]*z[7] + z[8]*z[8] + z[9]*z[9]);
        ...
        z[8] = sp * cos(t[8] * pwr) + c[8];
        z[9] = sp * sin(t[8] * pwr) + c[9];
...
float sdfJulia10D_simple(vec3 pos, float pwr, float bail, int maxIt) {
    ...
    for (int i = 0; i < MAX_ITER_HQ; i++) {
        ...
        r = sqrt(z[0]*z[0] + z[1]*z[1] + z[2]*z[2] + z[3]*z[3] + z[4]*z[4] + z[5]*z[5] + z[6]*z[6] + z[7]*z[7] + z[8]*z[8] + z[9]*z[9]);
        if (r > bail) break;
