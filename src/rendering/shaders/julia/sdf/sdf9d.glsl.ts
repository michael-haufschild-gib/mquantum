...
// ============================================
// 9D Julia SDF - Array-based with inversesqrt optimization
...
float sdfJulia9D(vec3 pos, float pwr, float bail, int maxIt, out float trap) {
    ...
    c[4] = 0.0; c[5] = 0.0; c[6] = 0.0; c[7] = 0.0; c[8] = 0.0;
    ...
    for (int i = 0; i < MAX_ITER_HQ; i++) {
        ...
        r = sqrt(z01_sq + z[2]*z[2] + z[3]*z[3] + z[4]*z[4] + z[5]*z[5] + z[6]*z[6] + z[7]*z[7] + z[8]*z[8]);
        ...
        z[7] = sp * cos(t[7] * pwr) + c[7];
        z[8] = sp * sin(t[7] * pwr) + c[8];
...
float sdfJulia9D_simple(vec3 pos, float pwr, float bail, int maxIt) {
    ...
    for (int i = 0; i < MAX_ITER_HQ; i++) {
        ...
        r = sqrt(z[0]*z[0] + z[1]*z[1] + z[2]*z[2] + z[3]*z[3] + z[4]*z[4] + z[5]*z[5] + z[6]*z[6] + z[7]*z[7] + z[8]*z[8]);
        if (r > bail) break;
