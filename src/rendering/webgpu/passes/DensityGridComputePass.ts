...
export class DensityGridComputePass extends WebGPUBaseComputePass {
  ...
  protected async createPipeline(ctx: WebGPUSetupContext): Promise<void> {
    ...
    // SchroedingerUniforms: 1456 bytes (matches SCHROEDINGER_UNIFORM_SIZE in renderer)
    this.schroedingerBuffer = this.createUniformBuffer(device, 1456, 'density-schroedinger')
