...
export class DensityGridComputePass extends WebGPUBaseComputePass {
  ...
  protected async createPipeline(ctx: WebGPUSetupContext): Promise<void> {
    ...
    // SchroedingerUniforms: 1424 bytes (matches SCHROEDINGER_UNIFORM_SIZE in renderer)
    this.schroedingerBuffer = this.createUniformBuffer(device, 1424, 'density-schroedinger')
