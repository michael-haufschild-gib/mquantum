...
import { finiteNonNegativeReadbackOrZero, finiteReadbackOrZero } from '../normalizationGuards'
        ...
        staging
          ...
          .then(() => {
            ...
            useDiagnosticsStore
              .getState()
              .pushQwDiagnostics(
                finiteNonNegativeReadbackOrZero(totalNorm),
                stepCount,
                finiteReadbackOrZero(posSum),
                finiteReadbackOrZero(posSqSum)
              )
          })
          .catch(() => {
            this.mappingInFlight = false
