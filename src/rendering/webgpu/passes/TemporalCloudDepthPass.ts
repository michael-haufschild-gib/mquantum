 ...
 * This enables depth-dependent post-processing effects to work with
 ...
 * standard depth buffer. Post-processing effects that need depth can use
 * the output of this pass instead.
 *
 * @example
 * ```typescript
