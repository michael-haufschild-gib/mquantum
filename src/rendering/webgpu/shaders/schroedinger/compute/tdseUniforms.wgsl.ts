...
struct TDSEUniforms {
  ...
  fieldView: u32,            // offset 284 (0=density, 1=phase, 2=current, 3=potential, 4=superfluidVelocity, 5=healingLength, 6=machNumber, 7=hawkingFlux, 8=quantumPressure, 9=vorticity, 10=ctcResidual, 11=ctcLoopGain)
