...
describe('QUANTUM_TYPE_REGISTRY', () => {
  ...
  it('declares evolution reset behavior for every entry', () => {
    ...
    expect(resetKinds).toEqual({
      ...
      modularKnot: 'schroedingerAnalytic',
      constraintSeam: 'schroedingerAnalytic',
      moebiusNoBoundary: 'schroedingerAnalytic',
      forcedCell: 'schroedingerAnalytic',
      turningSurface: 'schroedingerAnalytic',
      primonMultiverse: 'schroedingerAnalytic',
      frobeniusWheel: 'schroedingerAnalytic',
      dewittCone: 'schroedingerAnalytic',
      selbergSpectrum: 'schroedingerAnalytic',
      adelicWavefunction: 'schroedingerAnalytic',
      weilPositivity: 'schroedingerAnalytic',
      fieldOneElement: 'schroedingerAnalytic',
      pauliSpinor: 'pauli',
      bellTest: 'bellPair',
    })
  })
