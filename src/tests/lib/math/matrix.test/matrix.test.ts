...
describe('Matrix Operations', () => {
  describe('createIdentityMatrix', () => {
    ...
    it('throws error for invalid dimension', () => {
      ...
      expect(() => createIdentityMatrix(Number.NaN)).toThrow()
      expect(() => createIdentityMatrix(1025)).toThrow('exceeds')
    })
  })
  ...
  describe('createZeroMatrix', () => {
    ...
    it('throws before allocating unsafe matrix sizes', () => {
      expect(() => createZeroMatrix(Number.POSITIVE_INFINITY, 1)).toThrow()
      expect(() => createZeroMatrix(1024, 1025)).toThrow('exceeds')
    })
  })
  ...
  describe('determinant', () => {
    ...
    it('rejects dimensions that would make recursive determinant explode', () => {
      expect(() => determinant(createIdentityMatrix(9))).toThrow('recursive limit')
    })
  })
