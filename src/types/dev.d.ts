...
import type { useDiagnosticsStore } from '@/stores/diagnostics/diagnosticsStore'
import type { useMeasurementStore } from '@/stores/diagnostics/measurementStore'
import type { usePerformanceMetricsStore } from '@/stores/diagnostics/performanceMetricsStore'
import type { useSrmtDiagnosticStore } from '@/stores/diagnostics/srmtDiagnosticStore'
import type { useSrmtSweepStore } from '@/stores/diagnostics/srmtSweepStore'
import type { usePerformanceStore } from '@/stores/runtime/performanceStore'
...
import type { usePostProcessingStore } from '@/stores/scene/postProcessingStore'
import type { useLayoutStore } from '@/stores/ui/layoutStore'
import type { useUIStore } from '@/stores/ui/uiStore'
